...
#hours and minutes are displayed on the 24h digital clock?The program should print two
#numbers: the number of hours (between 0 and 23) and the number of minutes (between 0 and 59).
